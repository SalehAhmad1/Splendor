    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await fetch('/api/women-wear-data');
                if (!response.ok) {
        ...
        <div className='min-h-screen w-full p-4'>
            {selectedImage && (
                <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-70 z-50">
                    <div className="modal flex flex-col sm:flex-row gap-4 min-h-10 min-w-10 max-w-4xl relative border-2 border-DeepGold rounded-lg shadow-xl bg-LimelightLightGreen p-4">
                        ...
                        <div className="img">
                            <Image src={selectedImage.image} alt={selectedImage.title} width={300} height={200} className='rounded-lg h-full w-full'/>
                        </div>
                        <div className="data flex flex-col justify-center items-start gap-8">
                            ...
                            <div className="modalBtns flex gap-4">
